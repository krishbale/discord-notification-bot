...
export class AppController {
  ...
  createorder(@Body() body: any) {
    ...
    content: `New push from ${body.repository.name} with commit message ${body.head_commit.message} by ${body.head_commit.author.name} ${body.head_commit.url} ${body.head_commit.message}`;
    this.httpService
      .post(
